...
//[deployer, seller, buyer] = [account1, account2, account3]
contract('Marketplace',([deployer, seller, buyer]) => {
    ...
    describe('deployment',async () => {
        ...
        it('has a name',async () =>{
            ...
            assert.equal(name,'Soumyadeep Marketplace')
        })
    })
    ...
    describe('products',async () => {
        ...
        it('sells products',async () =>{
            //check the seller balance before purchase
